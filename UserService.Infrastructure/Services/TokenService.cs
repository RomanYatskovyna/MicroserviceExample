...
public class TokenService : ITokenService
{
    ...
    public static TokenValidationParameters GetAccessValidationParameters(JwtAuthSettings settings)
    {
    ...
    {
        var tokenHandler = new JwtSecurityTokenHandler();
        var validationParameters = GetAccessValidationParameters(_jwtAuthSettings);
    ...
    public ClaimsPrincipal ValidateRefreshToken(string token)
    {
        ...
        {
            IssuerSigningKey = GetSymmetricSecurityKey(_jwtAuthSettings.RefreshSecret),
            ClockSkew = TimeSpan.FromSeconds(30),
            ValidateIssuerSigningKey = true,
            ValidateLifetime = true,
        };
    ...
    {
        return new SigningCredentials(GetSymmetricSecurityKey(secret), SecurityAlgorithms.HmacSha256Signature);
